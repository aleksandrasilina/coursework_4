...
def test_json_saver_add_vacancies_and_create_file(vacancy_1, vacancy_2, vacancy_3, json_saver):
...
def test_json_saver_add_vacancies(vacancy_1, vacancy_2, vacancy_3, vacancy_4, json_saver):
    """Тестирует метод для добавления списка экземпляров вакансий в существующий файл"""
    vacancies_list_1 = [vacancy_1, vacancy_2]
